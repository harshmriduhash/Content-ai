          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-400 mb-8">
                Streamline your content creation process with our AI-powered
                tools for writing, image generation, and video editing.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-12">
              ...
              >
                ...
                <p className="text-gray-400">
                  Generate engaging content with our advanced AI writing
                  assistant.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className="text-gray-400">
                  Edit and enhance videos with AI-powered tools and effects.
                </p>
              </div>
            </div>
          </div>
